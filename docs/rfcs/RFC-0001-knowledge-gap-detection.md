...
| `packages/mukti-docs/planning/unified-thinking-model.md` | Documents "Anti-Resolution Signals" and frustration patterns               |
...
- [Unified Thinking Model](../../packages/mukti-docs/planning/unified-thinking-model.md)
