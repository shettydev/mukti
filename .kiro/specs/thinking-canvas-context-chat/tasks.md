...
- [x] 1. Create backend dialogue data models
  - [x] 1.1 Create NodeDialogue schema
  ...
  - [x] 1.2 Create DialogueMessage schema
    ...
    - _Requirements: 9.1, 9.4_
  - [x] 1.3 Register schemas in module
    - Update canvas module to import new schemas
    - _Requirements: 9.1_

- [x] 2. Create dialogue module and service
  - [x] 2.1 Create dialogue module structure
    ...
    - _Requirements: 9.1_
  - [x] 2.2 Implement DialogueService
  ...
  - [x] 2.3 Implement AI prompt construction
  ...
  - [x] 2.6 Implement DialogueController
...
- [-] 5. Create chat state management
  - [x] 5.1 Create chat Zustand store
...
- [x] 6. Create chat panel components
  ...
  - [x] 6.2 Create ChatInput component
    ...
    - _Requirements: 2.1_
  - [x] 6.3 Create DialogueHeader component
  ...
  - [x] 6.4 Create NodeChatPanel component
  ...
  - [x] 6.6 Create chat components barrel export
...
- [x] 8. Create insight node functionality
  - [x] 8.1 Create InsightNodeDialog component
  ...
  - [x] 8.2 Create InsightNode component
    ...
    - _Requirements: 3.5_
  - [x] 8.3 Update node types and layout utilities
  ...
  - [x] 8.4 Implement insight creation in canvas store
...
- [x] 9. Create exploration tracking
  - [x] 9.1 Update node components with exploration indicators
    - Update SeedNode, SoilNode, RootNode, InsightNode components
    - Add badge showing message count or checkmark for explored
    - _Requirements: 6.1, 6.2_
  - [x] 9.2 Create exploration status utilities
    ...
    - _Requirements: 6.3_
  - [x] 9.3 Update CanvasLegend with exploration indicators
...
- [x] 10. Integrate chat panel with canvas
  - [x] 10.1 Update ThinkingCanvas to include chat panel
  ...
  - [x] 10.2 Implement panel size persistence
