    ...
    <div className="min-h-screen w-full bg-[#020617] relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 lg:py-48 relative z-10">
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
          <AnimatedContent distance={30} direction="vertical" duration={0.8} delay={0.2}>
          ...
          <AnimatedContent distance={50} direction="horizontal" duration={1} delay={1.8}>
            <GradientText
          ...
          <AnimatedContent distance={40} direction="vertical" duration={0.9} delay={0.8}>
            <BlurText
          ...
          <AnimatedContent distance={30} direction="vertical" duration={0.8} delay={1.2}>
          ...
          <AnimatedContent distance={20} direction="vertical" duration={0.8} delay={1.6}>
            <div className="mt-48 sm:mt-12 flex flex-col items-center justify-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm text-muted-foreground px-4 sm:px-0">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <ShinyText text="1000+ Early Users" className="text-muted-foreground" speed={5} />
                </div>
                <span className="text-xs italic text-muted-foreground/70">
