...
const SCREEN_X = 14.25;
const SCREEN_Y = 14.25;
const SCREEN_WIDTH = 402;
const SCREEN_HEIGHT = 855;
const SCREEN_RADIUS = 60.75;
...
export function Iphone({ children, className, src, style, videoSrc, ...props }: IphoneProps) {
  ...
  return (
    ...
    >
      ...
      {!hasVideo && src && (
        ...
        >
          <Image alt="" className="block size-full object-cover object-top" src={src} />
        </div>
      )}
