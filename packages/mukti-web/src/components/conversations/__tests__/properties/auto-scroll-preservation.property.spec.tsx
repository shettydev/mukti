...
describe('MessageList - Auto-scroll Preservation (Property-Based)', () => {
  ...
  describe('Auto-scroll Preservation', () => {
    it('should auto-scroll when user is at bottom and new messages arrive', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.record({
    ...
    it('should resume auto-scroll when user manually scrolls to bottom', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.record({
            conversationId: fc.uuid(),
    ...
    it('should batch scroll updates when multiple messages arrive rapidly', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.record({
            conversationId: fc.uuid(),
    ...
    it('should maintain bottom position as new messages arrive when at bottom', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.record({
            conversationId: fc.uuid(),
