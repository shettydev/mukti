...
describe('useConversationStream - Stream Closure on Navigation (Property-Based)', () => {
  ...
  describe('Stream Closure on Navigation', () => {
    it(
      'should close EventSource connection when hook unmounts',
      async () => {
        await fc.assert(
          fc.asyncProperty(
            fc.record({
    ...
    it(
      'should clear reconnection timeout when unmounting',
      async () => {
        await fc.assert(
          fc.asyncProperty(
            fc.record({
    ...
    it(
      'should not process messages after unmount',
      async () => {
        await fc.assert(
          fc.asyncProperty(
            fc.record({
    ...
    it(
      'should handle unmount during active message processing',
      async () => {
        await fc.assert(
          fc.asyncProperty(
            fc.record({
    ...
    it(
      'should not create new connections after unmount',
      async () => {
        await fc.assert(
          fc.asyncProperty(
            fc.record({
